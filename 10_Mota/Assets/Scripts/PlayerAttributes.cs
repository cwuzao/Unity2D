...
public class PlayerAttributes : MonoBehaviour {
    ...
    public int _key_red;
    public bool _daoju_tujian = true;
    public bool _daoju_feixing = true;
	...
	void Start () {
        _GM = this.gameObject.GetComponent<Player>().GameController.GetComponent<GameManager>();
	}
	...
	void Update () {
        ...
        floor.text = "第  " + _GM.CurrentFloor + "  层";
        if (_daoju_tujian)
        {
